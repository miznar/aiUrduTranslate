...
from .views import home, GenerateTranscript, signup_email, complete_profile, signup_google,upload_and_transcribe,LoginView,update_interests,UpdatePasswordView,process_transcript_upload
